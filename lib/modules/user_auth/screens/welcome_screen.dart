...
import 'package:sabroso/modules/user_auth/widgets/register_modal.dart';
                      ...
                      Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text('Sabroso', style: TextStyle(fontFamily: 'inter', fontWeight: FontWeight.w700, fontSize: 32, color: Colors.white)),
                          ),
                          Text("Make it taste good", style: TextStyle(color: Colors.white)),
                        ],
                      ),
                      Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(
                                text: 'By joining Sabroso, you agree to our ',
